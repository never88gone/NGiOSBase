...
- (void)loadView
{
    ...
    [OTSConstraintHelper setView:self.dimmingView fullAsSuperview:self.view andEdgeInsets:self.dimmingEdge];
...
{
    OTSAppDelegate *app = (id)[UIApplication sharedApplication].delegate;
