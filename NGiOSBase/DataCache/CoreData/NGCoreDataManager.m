...
//DEF_SINGLETON(NGCoreDataManager)
@synthesize managedObjectContext = _managedObjectContext;
@synthesize managedObjectModel = _managedObjectModel;
@synthesize persistentStoreCoordinator = _persistentStoreCoordinator;

+(id)managerWithCoreDataPath:(NSString*)path{
    NGCoreDataManager *ma=[[NGCoreDataManager alloc] init];
...
-(void)insertWithClass:(Class)aClass insertBlock:(NGCoreDataInsertBlock)block
{
    [self insertWithClass:aClass insertBlock:block complite:nil];
    
}
-(void)insertWithClass:(Class)aClass insertBlock:(NGCoreDataInsertBlock)block complite:(void (^__nullable)(BOOL contextDidSave, NSError * _Nullable error))complite;
{
...
-(void)updateWithEntityName:(Class)aEntityName withPredicate:(NSPredicate *)aPredicate withDataBlock:(NGCoreDataInsertBlock)block;
{
