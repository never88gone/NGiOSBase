...
@interface NGMask () <UIGestureRecognizerDelegate>
...
@property (nonatomic, weak) NGWindow *window;
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        NGAppDelegate *delegate = (NGAppDelegate *)[UIApplication sharedApplication].delegate;
