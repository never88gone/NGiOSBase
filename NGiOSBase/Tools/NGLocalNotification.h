...
#import <Foundation/Foundation.h>
 UIKIT_EXTERN NSString * const NGLocalNotificationRouterUrl;

@interface NGLocalNotification : NSObject
 ...
 *
 * 		[NGLocalNotification createLocalNotificationWithName:kDailyBuyLocalNotificationName 
