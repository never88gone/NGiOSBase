...
#import "NGLocalNotification.h"
#import "NSMutableDictionary+safe.h"
#import "NSArray+safe.h"

NSString *const NGLocalNotificationRouterUrl = @"routerUrl";
const NSString* NGLocalNotificationValue = @"NGLocalNotificationValue";


@implementation NGLocalNotification
                              ...
                              routerUrl:(NSString *)routerUrl
{
    ...
    [dict safeSetObject:NGLocalNotificationValue forKey:notificationName];
    [dict safeSetObject:routerUrl forKey:NGLocalNotificationRouterUrl];
    if (userInfo != nil) {
...
+ (UILocalNotification *)findLocalNotificationWithName:(const NSString*)notificationName
{
    ...
    for(UILocalNotification* localNotification in localNotificationArray){
        ...
        if([notificationValue isEqualToString:(NSString*)NGLocalNotificationValue]){
