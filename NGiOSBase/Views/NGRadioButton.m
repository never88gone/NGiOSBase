...
@implementation NGRadioButton

- (void)setOtherButtons:(NSArray *)otherButtons {
    if (![NGRadioButton isGroupModifing]) {
        [NGRadioButton groupModifing:YES];
        for (NGRadioButton *radioButton in otherButtons) {
        ...
        [NGRadioButton groupModifing:NO];
    }
...
- (void)setMultipleSelectionEnabled:(BOOL)multipleSelectionEnabled {
    if (![NGRadioButton isGroupModifing]) {
        [NGRadioButton groupModifing:YES];
        for (NGRadioButton *radioButton in self.otherButtons) {
