...
{
	NGPageControl *pageControl = [[NGPageControl alloc] init];

	if (self.pageControl) {
		[self.pageControl removeFromSuperview];
	}
    pageControl.borderColor = [NGColor colorWithRGB:0xB2B2B2];
    ...
    [self.pageControl autoSetDimension:ALDimensionWidth toSize:UI_CURRENT_SCREEN_WIDTH];
