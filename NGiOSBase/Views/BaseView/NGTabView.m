          ...
          selImages:(NSArray *)cArray
{
    ...
    if (self) {
        ...
        for (int i=0; i<count; i++) {
            ...
            if (i == 0) {
                theIv.image = [UIImage imageNamed:selImageName bundleName:self.imgBundleName];
                
            } else {
                theIv.image = [UIImage imageNamed:normalImageName bundleName:self.imgBundleName];
            }
...
- (void)setCurrentIndex:(NSInteger)index
{
    ...
    oldSelectImageView.image = [UIImage imageNamed:[self.normalImages safeObjectAtIndex:self.currentIndex] bundleName:self.imgBundleName];
    currentSelectImageView.image = [UIImage imageNamed:[self.selImages safeObjectAtIndex:index] bundleName:self.imgBundleName];
