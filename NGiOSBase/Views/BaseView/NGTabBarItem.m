...
- (void)_NGTabBarItem_setupViews
{
    ...
    self.badgeLabel.backgroundColor = [NGColor colorWithRGB:0xff3c25];
    ...
    self.indicateView.backgroundColor = [NGColor colorWithRGB:0xff3c25];
...
{
    NGTabBarItem *item = [self viewWithFrame:CGRectZero];
...
- (void)setFrame:(CGRect)frame
{
    ...
    [self _NGTabBarItem_resizeViews];
}
...
- (void)_NGTabBarItem_resizeViews
{
