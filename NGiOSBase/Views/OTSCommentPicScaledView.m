...
@property(nonatomic, strong) OTSScrollView *mScrollView;

@end

@implementation OTSCommentPicScaledView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.mScrollView = [[OTSScrollView alloc]initWithFrame:self.bounds];
