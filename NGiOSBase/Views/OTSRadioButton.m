...
@implementation OTSRadioButton

- (void)setOtherButtons:(NSArray *)otherButtons {
    if (![OTSRadioButton isGroupModifing]) {
        [OTSRadioButton groupModifing:YES];
        for (OTSRadioButton *radioButton in otherButtons) {
        ...
        [OTSRadioButton groupModifing:NO];
    }
...
- (void)setMultipleSelectionEnabled:(BOOL)multipleSelectionEnabled {
    if (![OTSRadioButton isGroupModifing]) {
        [OTSRadioButton groupModifing:YES];
        for (OTSRadioButton *radioButton in self.otherButtons) {
