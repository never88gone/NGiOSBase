...
typedef void(^NGNoParamNoReturnBlock)(void);

typedef void(^NGIndexAndValueNoReturnBlock)(NSUInteger index, id value);
...
#define IS_IPHONE_5_8_LAND CGSizeEqualToSize(CGSizeMake(1125, 2436), [[UIScreen mainScreen] currentMode].size)
#define IS_IPHONE_6_1_LAND CGSizeEqualToSize(CGSizeMake(828, 1792), [[UIScreen mainScreen] currentMode].size)
#define IS_IPHONE_6_5_LAND CGSizeEqualToSize(CGSizeMake(1242, 2688), [[UIScreen mainScreen] currentMode].size)
...
// 本地化
#define NGSTRING(_str)  NSLocalizedString((_str),(_str))
